...
describe 'Bootstrap::Components::ButtonGroup', type: :feature, js: true do
  ...
  xit 'can render a button group vertical' do
    matestack_render do
  ...
  xit 'is possible to render a toolbar' do
    matestack_render do
