...
RSpec.describe "Bootstrap::Form::Input", type: :feature, js: true do
  ...
  xit 'renders bootstrap radio buttons with options as Array' do
  ...
  xit 'renders bootstrap radio buttons with options as Hash' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
  ...
  xit 'renders bootstrap radio buttons with options as Array, clicking multiple options but still sends a single value (was an error once)' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
        bs_form_radio key: :foo, options: [1, 2]
  ...
  xit 'renders bootstrap radio buttons with options as Hash, clicking multiple options but still sends a single value (was an error once)' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
        bs_form_radio key: :foo, options: { "Option 1": 1, "Option 2": 2 }
  ...
  xit 'renders bootstrap radio buttons with server errors (e.g. required and not clicked)' do
  ...
  xit 'renders bootstrap radio buttons with options as Array with init value' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
  ...
  xit 'renders bootstrap radio buttons with additional custom class' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
  ...
  xit 'renders bootstrap radio buttons with label' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
  ...
  xit 'renders bootstrap radio buttons with form text' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
  ...
  xit 'renders bootstrap radio buttons as inline variant' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
  ...
  xit 'renders disabled radio buttons' do
    form_config = get_form_config(path: radio_success_form_test_path)
    matestack_render do
      matestack_form form_config do
